...
N_EPOCHS = 19
loss_fn = nn.BCEWithLogitsLoss(pos_weight=torch.tensor([48.577777777777776]))
datasets_path = path_storage.datasets_path
output_path = 'OpenStack/eval_for_linelevel'
...
for i in range(N_EPOCHS):
    checkpoint = torch.load(f'../model/checkpoint/checkpoint_{i}.pth', map_location=device)
